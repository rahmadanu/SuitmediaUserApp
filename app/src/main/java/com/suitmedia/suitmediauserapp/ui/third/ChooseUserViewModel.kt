...
@HiltViewModel
class ChooseUserViewModel @Inject constructor(private val userRepository: UserRepository) :
    ViewModel() {

    val listUsers: LiveData<PagingData<User>>
        get() = userRepository.getUserLists().cachedIn(viewModelScope)
}